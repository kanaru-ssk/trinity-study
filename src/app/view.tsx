...
export function View({
  ...
  return (
    <main className="prose prose-neutral mx-auto max-w-5xl space-y-16 px-4 py-20">
      <div className="not-prose">
        <span className="inline-flex items-center rounded-full bg-card px-2 py-1 font-semibold text-[12px] text-primary leading-[1.33] tracking-[0.125px]">
          {formatDate(new Date(), "YYYY年M月")}最新
        </span>
        <h1 className="mt-4 mb-0 font-bold text-[40px] text-foreground leading-[1.1] tracking-[-1px]">
          日本版トリニティスタディ
        </h1>
      </div>
      <SimulationSection
...
const sectionHeading2 =
  "font-bold text-[26px] leading-[1.23] tracking-[-0.625px]";
const sectionHeading3 =
  "font-bold text-[22px] leading-[1.27] tracking-[-0.25px]";
...
function AboutSection() {
  return (
    <section>
      <Card>
        <CardContent>
          <h2 className={sectionHeading2}>当サイトについて</h2>
          <p>
            MSCI
...
function TrinityStudySection() {
  return (
    <section>
      <Card>
        <CardContent>
          <h2 className={sectionHeading2}>トリニティスタディとは？</h2>
          <p>
            1998年、
            <a
...
function AlgorithmSection() {
  return (
    <section>
      <Card>
        <CardContent>
          <h2 className={sectionHeading2}>シミュレーションアルゴリズム</h2>
          <p>
            このサイトで使用したプログラムは
            <a
          ...
          <h3 className={sectionHeading3}>試行回数について</h3>
...
function DataSourceSection() {
  return (
    <section>
      <Card>
        <CardContent>
          <h2 className={sectionHeading2}>データ入手元</h2>
          <dl>
            <dt>ACWI のチャートデータ</dt>
            <dd>
              <a
